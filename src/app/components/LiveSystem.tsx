          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "0.5rem", fontWeight: 700, color: "var(--fg-5)" }}
              >
                LORA TERMINAL
              </span>
              <div className="flex items-center gap-1.5">
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{ background: "var(--terminal-live-glow)" }}
                  />
                </div>
            ...
            <div className="p-5 md:p-6 font-mono space-y-2 min-h-[280px]">
              {terminalLines.slice(0, visibleLines).map((line, i) => (
                ...
                >
                  <span style={{ color: typeColor[line.type], fontSize: "0.75rem", lineHeight: 1.8 }}>{line.text}</span>
                </motion.div>
              ))}
