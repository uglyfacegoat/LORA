...
export const translations: Dict = {
  ...
  "cta.eyebrow": { en: "OUR SLOGAN", es: "NUESTRO LEMA", ru: "НАШ ЛОЗУНГ", zh: "我们的口号" },
  ...
  "contact.sub": { en: "Get a free audit of your current funnel. We'll show you exactly where revenue is being lost.", es: "Obtén una auditoría gratuita de tu embudo actual. Te mostraremos dónde se pierde el ingreso.", ru: "Получи бесплатный аудит текущей воронки. Мы покажем, где именно теряется выручка.", zh: "获取当前漏斗的免费审计，我们会明确告诉你收入具体流失在哪里。" },
  ...
  "contact.slot": { en: "Next audit slot", es: "Siguiente espacio", ru: "Ближайший слот", zh: "下一个审计档期" },
