        ...
        <div className="relative grid md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="flex-1">
                    <p
                      ...
                      style={{ fontSize: "0.52rem", fontWeight: 700, color: "var(--fg-4)", marginBottom: 2 }}
                    >
                      {r.label}
                    </p>
                    <p
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: "0 30px 100px -30px var(--surface-strong)",
            }}
          >
            <div
              className="absolute -top-24 -right-24 w-60 h-60 pointer-events-none"
            ...
            <div className="flex items-center justify-between mb-8 relative">
              <div className="flex items-center gap-3">
                ...
                <span
                  className="uppercase"
                  style={{ fontSize: "0.58rem", letterSpacing: "0.3em", fontWeight: 800, color: "var(--fg-1)" }}
                >
                  {t("cmp.us")}
                </span>
              </div>
              ...
              {rows.map((r, i) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p
                      className="uppercase tracking-[0.12em]"
                      style={{ fontSize: "0.52rem", fontWeight: 700, color: "var(--fg-3)", marginBottom: 2 }}
                    >
                      {r.label}
                    </p>
                    <p style={{ fontSize: "0.95rem", fontWeight: 600, color: "var(--fg-1)", lineHeight: 1.35 }}>
                      {r.us}
                    </p>
                  </div>
                </motion.li>
