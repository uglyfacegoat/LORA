  ...
  return (
    <SeoShell route={route}>
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-6" style={{ color: "var(--fg-3)", lineHeight: 1.7 }}>{localize(route.summary, lang)}</p>
        <a href={localizedPath("/", lang)} className="mt-8 inline-flex rounded-xl px-7 py-4 uppercase" style={{ background: "var(--cta-bg)", color: "var(--cta-fg)", fontSize: "0.62rem", letterSpacing: "0.22em", fontWeight: 800 }}>
          Back home
        </a>
      </div>
    </SeoShell>
